...
검증을 실행하면 `00-review-dashboard.html`이 현재 결정과 누락 사항을 기준으로 자동 갱신됩니다. 중단했다면 같은 폴더에서 “이어서 진행해”라고 요청하세요. 진행 관리자는 `00-workflow-state.json`을 읽어 다음 사용자 결정을 찾습니다.

## 기획 깊이

| 모드 | 적합한 상황 | 결과 |
| --- | --- | --- |
| Lite | 빠르게 방향을 확인할 때 | 7개 핵심 파일의 컨셉·브랜드·첫 버전 계획·주요 흐름·디자인 전달 문서 |
