...
2. Assign stable IDs to every P0/P1 surface, action, required state, operation, and journey. Preserve existing IDs during edits. Attach product-definition requirement/persona/entry-point IDs rather than inventing a second source list.
...
7. Write happy, exception, and boundary journeys, including refresh, back, and cross-device behavior. Every confirmed entry point reaches a journey with the same persona.
